...
INSERT INTO `funerals` (`id`, `family_name`, `deceased`, `name`, `day1`, `day2`, `dinner`, `lunch`, `funeral_style`, `created_at`, `updated_at`)
VALUES
(1, '山田家', '山田太郎', '山田次郎', '2023-01-01', '2023-01-02', 10, 10, '2日間仏式', now(), now());
